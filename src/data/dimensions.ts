...
export type DimKey = typeof dimensionOrder[number];

export const dimensionMeta: Record<DimKey, { name: string; model: string }> = {
...
export const DIM_EXPLANATIONS: Record<DimKey, Record<'L'|'M'|'H', string>> = {
